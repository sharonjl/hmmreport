...
\subsection{Retraining and noise variations}
We perform one last experiment with this data set as it provides us with a great opportunity to retrain an existing HMM
Overall, this result tells us the sucess of the experiment in implementing it for use with Xbox Kinect. Assuming we provide sufficient training for each emotion or gesture that needs to be classified correctly, HMMs are quite robust to variations, very easy for re-training and adaptation.
